...
- LayerZero transport for supported omnichain routes
...
LayerZero supports the omnichain movement of supported stablecoin flows between Tempo and connected EVM routes. Parly keeps private execution centered on Tempo while allowing supported networks to participate through a coherent hub-and-spoke model.
