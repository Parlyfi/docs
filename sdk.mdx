...
Cross-chain deposits are handled by Parly payment-route APIs. Cross-chain private sends require a dedicated public payout route before they are exposed through the SDK.
